    ...
    return(
        ...
        <section className="px-6 sm:px-10 md:px-16 lg:px-24 xl:px-32 pb-20 grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-20">
            <div className="flex flex-col">
                <div className="border-t border-[#00CFFF] w-20 mb-4"></div>
                ...
                <button className="bg-[#00CFFF] text-white text-sm sm:text-base font-semibold px-6 py-2 rounded max-w-[100px]">Enviar</button>
            </div>
